        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-footer-widget">
                        <div class="footer-logo">
                            {{-- <a href="index.html"><img src="{{ asset('img/logo/footer.png') }}" alt=""></a> --}}
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-footer-widget">
                        <h3>GET IN TOUCH</h3>
                        <a href="tel:000000000"><i class="fa fa-phone"></i>555-555-1212</a>
                        <span><i class="fa fa-envelope"></i>info@example.com</span>
                        <span><i class="fa fa-globe"></i>www.knc.com.bd</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 col-12">
                    <span>Copyright &copy; Educat 2017.All right reserved.Developed by <a href="#">TechLogic</a></span>
                </div>
